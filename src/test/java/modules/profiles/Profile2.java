 ...
 * @author Erwin
 *
 *         Menu links - My Account Yes - Dashboard No
 * 
 *         Menu items - Home Yes - Online Navigation Yes - Navigation Software
 *         Yes - Real-Time Maps Yes - Bridge Yes - Sports No
 * 
 ...
 * 
 *         Sidebar Navigation Software - Navkit Yes - Downloads No - FAQ No -
 *         Integration Kit No
 * 
 ...
 * 
 *         Sidebar Sports No - Overview No - Camera Media Server No - MySports
 *         Cloud No
 * 
...
public class Profile2 extends AbstractProfile {
	...
	public boolean hasCorrectMenuLinks(User user, Page myPage) {
		return super.hasCorrectMenuLinks(user, myPage, true, false);
	}
