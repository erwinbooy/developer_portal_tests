...
/**
 * This is the Abstract class for the Profiles It will hold all the information
...
public abstract class AbstractProfile implements Profile {
	 ...
	 * @return true/false
	 */
	public boolean hasCorrectMenuLinks(User user, Page myPage, boolean account, boolean dashboard) {
	 ...
	 * 
	 * Menu items - Home - Online Navigation - Navigation Software - Real-Time
	 * Maps - Bridge - Sports
	 * 
	 * @param user
	 * @param myPage
	 * @return true/false
	 */
	public boolean hasCorrectMenuItems(User user, Page myPage, boolean home, boolean on, boolean ns, boolean rtm,
			boolean bridge, boolean sports) {
	 ...
	 * 
	 * Sidebar Online Navigation - Overview Yes - Online Routing Yes - Online
	 * Maps Yes - Online Search Yes - Online Traffic Yes - Maps SDK Yes -
	 * Request Access Yes - API Explorer Yes
	 * 
	 * @param user
	 * @param myPage
	 * @return true/false
	 */
	public boolean hasCorrectSidebarItemsON(User user, OnlineNavigationPage myPage, boolean ov, boolean or, boolean om,
			boolean os, boolean ot, boolean maps, boolean ra, boolean ae) {
	...
	/**
	 * Sidebar Navigation Software - Navkit Yes - Downloads Yes - Documentation
	 * Yes - FAQ Yes - Integration Kit Yes
	 *
	 * @param user
	 * @param myPage
	 * @return true/false
	 */
	public boolean hasCorrectSidebarItemsNS(User user, NavigationSoftwarePage myPage, boolean nk, boolean dl,
			boolean doc, boolean faq, boolean ik) {
